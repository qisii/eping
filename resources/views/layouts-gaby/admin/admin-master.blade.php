      ...
      <div class="sidebar shadow" id="side_nav">
        ...
        <ul class="list-unstyled">
          <li class="nav-dashboard">
            <a class="px-3 py-2 d-block" href="{{ url('admin/dashboard') }}"
              ><i class="fa-solid fa-chart-line"></i> Dashboard</a
            >
          </li>
          <li class="nav-usermanage">
            <a class="px-3 py-2 d-block" href="{{ url('admin/users') }}"
              ><i class="fa-solid fa-bars-progress"></i>User Management</a
            >
          </li>
        </ul>
        ...
        <!-- bottom navigation side panel ends-->
      </div>
      <!-- sidebar div ends -->
