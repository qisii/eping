...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">All Confirmed Crimes in Iligan City</li>
    </ol>
        ...
        function initializeMap() {
            ...
            for (var location of locations) {
                ...
                google.maps.event.addListener(marker, 'click', (function(marker, location) {
                    return function() {
                        infowindow.setContent("Reporter: " + location.name  + "<br>" + "Latitude: " + location.latitude + "<br>" + "Longitude: " + location.longitude + "<br>" + "Location: " + location.location + "<br>" + "Date Added: "+ location.date);
